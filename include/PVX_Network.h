...
namespace PVX {
	namespace Network {
		...
		public:
			...
			int SendFragmented(const std::vector<unsigned char> & Data, int FragmentSize = 0x00800000);
		...
		public:
			TcpServer_Old(const char * Post) : TcpSocket(Post), ServingThread(nullptr), ThreadCount(0){};
			~TcpServer_Old();
